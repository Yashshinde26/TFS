...
const facultyMembers: TeamMember[] = [
  {
    id: "neelam-shetty",
    name: "Dr. Neelam Shetty",
    title: "Vice Principal (Commerce)",
    bio: "Dr. Neelam Shetty, Vice Principal (Commerce), holds an M.Com., PGDBA, M.Phil., and a Ph.D. With over 17 years of professional experience bridging the corporate sector and academia, her research interests include Entrepreneurship and Work-Life Balance.",
    image: "/placeholder.svg",
    email: "neelam.shetty@xaviers.edu",
    linkedin: "",
    achievements: [
      "Vice Principal (Commerce)",
      "M.Com., PGDBA, M.Phil., and Ph.D.",
      "Over 17 years of professional experience",
      "Former Visiting Lecturer at the London School of Business and Finance",
      "TEDx Speaker (\"Being the Entrepreneur of Your Life\")",
    ],
    expertise: [
      "Management Studies",
      "Entrepreneurship",
    ...
    quote:
      "Inspiring students to become the entrepreneurs of their own lives through a blend of practical training and academic rigor.",
  },
  {
    id: "sanjay-parab",
  ...
  },
  {
    ...
    name: "Fr. Ambrose Machado, S.J.",
    title: "Head of Department (BAF) and Assistant Professor",
    bio: "Fr. Ambrose Machado, S.J., Head of Department (BAF) and Assistant Professor, holds an M.Com. degree. With 8 years of teaching experience, his research interests include Finance, Banking, and Insurance.",
    image: "",
    email: "Ambrose.Machado@xaivers.edu",
    linkedin: "",
    achievements: [
      "Head of Department (BAF)",
      "M.Com.",
    ...
    quote:
      "Dedicated to fostering academic excellence and a spirit of social responsibility within the commerce department.",
  },
  {
    id: "kamalika-ray",
...
const leadershipMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Eesha Teotia is the Vice Chairperson – Management at The Finance Symposium (TFS), overseeing internal operations, event management, and team coordination at St. Xavier's College, Mumbai.",
    image: "/placeholder.svg",
    email: "eesha.teotia@student.xaviers.edu",
    linkedin: "eesha-teotia",
    achievements: [
